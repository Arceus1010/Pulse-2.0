    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="flex flex-col items-center gap-3 text-center max-w-sm">
          ...
          <h1 className="text-lg font-semibold text-slate-800 dark:text-zinc-100">Settings</h1>
          ...
          <span className="mt-1 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/40 text-amber-700 dark:text-amber-400 text-xs font-semibold uppercase tracking-widest">
            Coming soon
          </span>
        </div>
      </div>
