...
export const newsSources: SourceBreakdown[] = [
  { name: 'The Star Online', posts: 4820, positive: 55, negative: 25, neutral: 20 },
  { name: 'Malaysiakini', posts: 3210, positive: 20, negative: 60, neutral: 20 },
  { name: 'New Straits Times', posts: 2980, positive: 45, negative: 30, neutral: 25 },
  { name: 'Free Malaysia Today', posts: 2540, positive: 30, negative: 50, neutral: 20 },
  { name: 'BizWire MY', posts: 1870, positive: 15, negative: 70, neutral: 15 },
  { name: 'Malay Mail', posts: 1640, positive: 40, negative: 35, neutral: 25 },
  { name: 'The Edge MY', posts: 1120, positive: 35, negative: 45, neutral: 20 },
  { name: 'Sinar Harian', posts: 980, positive: 25, negative: 55, neutral: 20 },
]

export const socialSources: SourceBreakdown[] = [
  { name: 'Twitter / X', posts: 77440, positive: 35, negative: 45, neutral: 20 },
  { name: 'News Sites', posts: 52980, positive: 38, negative: 38, neutral: 24 },
  { name: 'Facebook', posts: 36532, positive: 40, negative: 35, neutral: 25 },
  { name: 'Forums', posts: 22417, positive: 22, negative: 52, neutral: 26 },
  { name: 'TikTok', posts: 14200, positive: 55, negative: 25, neutral: 20 },
  { name: 'Blogs', posts: 14265, positive: 30, negative: 40, neutral: 30 },
]
...
export const newsAuthors: Author[] = [
  { id: 'a1', name: 'Ahmad Zafrul', handle: '@azafrul', platform: 'twitter', reach: '98.2k', sentiment: 'negative', initials: 'AZ', recentStatement: "SSM's enforcement is long overdue but the penalties seem arbitrary — small businesses bear the brunt while large shell networks persist undetected. The new Companies Act amendments need clearer implementation guidelines." },
  ...
  { id: 'a3', name: 'Farhan Ibrahim', handle: '@farhanibr', platform: 'twitter', reach: '31k', sentiment: 'neutral', initials: 'FI', recentStatement: 'MySSM portal works great for basic registration. But try doing a director change or share transfer — still clunky. Full digitisation is still a work in progress.' },
]

export const socialAuthors: Author[] = [
  { id: 's1', name: 'shamhr00', handle: 'TikTok', platform: 'tiktok', reach: '2.3k likes', sentiment: 'positive', initials: 'SH', recentStatement: 'POV: You just registered your company on MySSM in under 10 minutes 🤯 — the process is genuinely fast now. Old system needed like 3 trips to the office.' },
  { id: 's2', name: 'sinarharianonline', handle: 'TikTok', platform: 'tiktok', reach: '7.7k likes', sentiment: 'neutral', initials: 'SN', recentStatement: 'Datuk Seri Abdul Halim Aman dilantik sebagai Ketua Pesurujaya Suruhanjaya Pencegahan Rasuah Malaysia (SPRM) baharu berkuatkuasa pada 13 Mei 2026.' },
  { id: 's3', name: '@KLFinanceWatch', handle: 'Twitter', platform: 'twitter', reach: '52k followers', sentiment: 'neutral', initials: 'KF', recentStatement: "Reminder: SSM annual return filings due end of April. Late fees of RM50/day apply. Use the new MySSM portal to file online — it's actually pretty seamless now." },
]
